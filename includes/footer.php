    ...
    <div class="container text-md-left">
        <div class="row text-md-left">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p><a href="<?php echo APP_URL; ?>/search.php" class="text-white text-decoration-none">Search PGs</a></p>
                <p><a href="#" class="text-white text-decoration-none">How it Works</a></p>
                <p><a href="#" class="text-white text-decoration-none">List Your PG</a></p>
                <p><a href="#" class="text-white text-decoration-none">Testimonials</a></p>
            </div>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p><i class="fas fa-home mr-3"></i> 1st Gate Belgavi India</p>
                <p><i class="fas fa-envelope mr-3"></i> support@campusstay.com</p>
                <p><i class="fas fa-phone mr-3"></i> +91 9972548996</p>
            </div>
        </div>
            ...
            <div class="col-md-7 col-lg-8">
                <p>Copyright © <?php echo date('Y'); ?> All rights reserved by:
                    <a href="#" class="text-decoration-none">
                        <strong class="text-primary">CampusStay</strong>
                    </a>
                </p>
            </div>
