        ...
        <div class="col-lg-3">
            <div class="glass-card p-4 h-100">
                <nav class="nav flex-column gap-2">
                    ...
                    <a href="revenue.php" class="sidebar-link"><i class="fa-solid fa-wallet"></i> Revenue</a>
                ...
                <form action="process-profile.php" method="POST" enctype="multipart/form-data">
                    <div class="row g-4">
                        <div class="col-md-4 text-center">
                            <img src="<?php echo getImageUrl($user['profile_image']); ?>" class="rounded-circle border mb-3" width="150" height="150" alt="Profile">
                            <div class="mb-3">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Business/Full Name</label>
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-5 py-3 fw-bold mt-3">Update Account</button>
                        </div>
                    </div>
                </form>
            </div>
